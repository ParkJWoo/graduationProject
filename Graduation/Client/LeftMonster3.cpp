...
HRESULT CLeftMonster3::Initialize()
{
...
int CLeftMonster3::Update()
{
	...
	if (nullptr != m_pTarget)
	{
		...
		if (0 < m_tData.iHp && m_tData.iHp <= 4)
		{
...
void CLeftMonster3::LateUpdate()
{
	CObj::MoveFrame();
}

void CLeftMonster3::Render()
{
