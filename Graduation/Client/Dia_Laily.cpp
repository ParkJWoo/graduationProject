...
int CDia_Laily::Update()
{
	return 0;
}

void CDia_Laily::LateUpdate()
{
}

void CDia_Laily::Render()
{
	const TEXINFO* pTexInfo = CTextureMgr::GetInstance()->GetTexture(L"Dia_Laily",L"Dia_Laily", 0);
